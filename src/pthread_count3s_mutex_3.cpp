//CONTAGEM DE 3s COM CONTROLE DE REGIÃO CRÍTICA FORA DO LAÇO DE COMPARAÇÃO. USO DE VARIÁVEL PRIVADA À TASK DE CADA THREAD. ESPERA-SE RESULTADO BEM MELHOR DO QUE O CASO _1 COM MUTEX DENTRO DO LAÇO
#include <iostream>
#include <pthread.h>
#include <cstdlib>
#include <ctime>
